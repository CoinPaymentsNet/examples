...
$payload = [
    ...
    "items" => [
        [
            ...
            "amount" => strval($quantity * $price)
        ]
    ],
    "amount" => [
        "breakdown" => [
            "subtotal" => strval($quantity * $price), // sum of purchased items
        ],
        "total" => strval($quantity * $price), // total amount of the invoice
    ],
    "payment" => [
...
$response = $apiHelper->sendApiRequest('POST', '/api/v2/merchant/invoices', $payload);
